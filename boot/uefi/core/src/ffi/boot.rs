...
use super::primitives::{ PhysicalAddress, Status, Event, Guid, Handle, TableHeader, VirtualAddress };
use super::system;
use core::ffi::c_void;
...
pub struct Services {
    ...
    pub open_protocol : extern "win64" fn(handle : Handle, protocol : *mut Guid, interface : *mut *mut c_void, agent_handle : Handle, controller_handle : Handle, attributes : OpenProtocolAttributes) -> Status,
