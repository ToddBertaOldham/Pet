...
pub struct Protocol {
    pub revision : u64,
    pub open : extern "win64" fn(this : *mut Protocol, new_handle : *mut *mut Protocol, file_name : *mut u16, open_mode : OpenModes, attributes : Attributes) -> Status,
    pub close : extern "win64" fn(this : *mut Protocol) -> Status,
    pub delete : extern "win64" fn(this : *mut Protocol) -> Status,
    pub read : extern "win64" fn(this : *mut Protocol, buffer_size : *mut usize, buffer : *mut c_void) -> Status,
    pub write : extern "win64" fn(this : *mut Protocol, buffer_size : *mut usize, buffer : *mut c_void) -> Status,
    ...
    pub get_info : extern "win64" fn(this : *mut Protocol, information_type : *mut Guid, buffer_size : *mut usize, buffer : *mut c_void) -> Status,
    pub set_info : extern "win64" fn(this : *mut Protocol, information_type : *mut Guid, buffer_size : usize, buffer : *mut c_void) -> Status,
    pub flush : extern "win64" fn(this : *mut Protocol) -> Status,
    pub open_ex : extern "win64" fn(this : *mut Protocol, new_handle : *mut *mut Protocol, file_name : *mut u16, open_mode : OpenModes, attributes : Attributes, token : *mut IOToken) -> Status,
...
impl SystemInfo {
    pub const ID : Guid = Guid { data_1 : 0x9576e93, data_2 : 0x6d3f, data_3 : 0x11d2, data_4 : [ 0x8e, 0x39, 0x00, 0xa0, 0xc9, 0x69, 0x72, 0x3b ] };
}
...
impl Info {
    pub const ID : Guid = Guid { data_1 : 0x9576e92, data_2 : 0x6d3f, data_3 : 0x11d2, data_4 : [ 0x8e, 0x39, 0x00, 0xa0, 0xc9, 0x69, 0x72, 0x3b ] };
}