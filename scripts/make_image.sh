...
mmd -i image/boot.img ::/pet
mcopy -i image/boot.img target/x86_64-unknown-uefi/debug/uefi_loader.efi ::EFI/BOOT/BOOTX64.EFI
mcopy -i image/boot.img target/x86_64-unknown-none/debug/kernel ::pet/kernel
